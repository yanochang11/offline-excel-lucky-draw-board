# 🏆 2026 尾牙春酒抽獎名單自動輪播看板 (Offline Excel Lucky Draw Board)

> **專為台灣福委會、行政人員設計的「零門檻」抽獎公告系統。不需連網、資料不外流，用 Excel 就能控制大螢幕！**

## 💡 為什麼開發這個工具？ (Why)
身為一個產品經理 (PM)，看到每年尾牙，行政同仁為了「如何在大螢幕上公平、漂亮地呈現得獎名單」而頭痛。市面上的線上抽獎程式需要連網（擔心個資外洩），PPT 手動播放又太累。
...
1.  前往 [**Releases 頁面**](https://github.com/您的帳號/offline-excel-lucky-draw-board/releases) 下載最新的懶人包 (ZIP)。
